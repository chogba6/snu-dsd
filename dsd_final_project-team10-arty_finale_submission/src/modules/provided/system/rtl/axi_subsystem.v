module axi_subsystem
  (/*AUTOARG*/
   ...
   m04_apb_pslverr, m05_apb_pready, m05_apb_prdata, m05_apb_pslverr
    ...
    assign aresetn_s00_out = aresetn;
    assign aresetn_s01_out = aresetn;
    assign aresetn_s02_out = aresetn;
    assign aresetn_s03_out = aresetn;
    assign aresetn_m00_out = aresetn;

    axi_interconnect_1 //s00 s01 sync, m00 async
      u_axi_datapath0
        (
         // ARESET_OUT_N ports are now inputs in Vivado 2024.1
