...
module fc_apb
  (
    ...
    input wire [31:0] PADDR,   // APB address ?ó¨Í∏∞ÏÑú faddr + 0x10 ?ù¥Î©? feature receiving?ù¥ ?Åù?Ç¨?ùå?ùÑ ?ïå?†§Ï§?-> prdataÎ°? ?ïå?†§Ï§ò„Öë?ï®  faddr + 0x00, 0xi Î©? iÎ≤àÏß∏ state?ûÑ?ùÑ ?ïå?†§Ï§?
    ...
    output reg fc_start,
    input wire fc_done,
    //output wire [3:0] fc_state, //to fc_module, ?ñ¥?ñ§ stateÎ•? ?ãú?ûë?ï†Ïß?
